...
function showMainDialog()
 ...
 local bottomButtonLayout = LinearLayout(service)
 bottomButtonLayout.setOrientation(0)
 bottomButtonLayout.setGravity(17)
 bottomButtonLayout.setPadding(0, 20, 0, 10)

 local aboutButton = Button(service)
 aboutButton.setText("About")
 aboutButton.setTextSize(16)
 aboutButton.setLayoutParams(LinearLayout.LayoutParams(
 0,
 LinearLayout.LayoutParams.WRAP_CONTENT,
 1
 ))
 aboutButton.setPadding(0, 0, 10, 0)
 aboutButton.setFocusable(true)

 local exitButton = Button(service)
 exitButton.setText("Exit")
 exitButton.setTextSize(16)
 exitButton.setLayoutParams(LinearLayout.LayoutParams(
 0,
 LinearLayout.LayoutParams.WRAP_CONTENT,
 1
 ))
 exitButton.setPadding(10, 0, 0, 0)
 ...
 bottomButtonLayout.addView(aboutButton)
 bottomButtonLayout.addView(exitButton)
 mainLayout.addView(bottomButtonLayout)

 newAlarmButton.onClick = function()
 showNewAlarmDialog()
 end

 viewAlarmsButton.onClick = function()
 showAlarmsListDialog()
 end

 notificationButton.onClick = function()
 show_notification_settings_dialog()
 end

 stopAllAlarmsButton.onClick = function()
 stop_all_alarms()
 end

 alarmDurationButton.onClick = function()
 ...
 dlg.setView(layout)
 dlg.show()
 newAlarmButton.requestFocus()
end

showMainDialog()
service.speak("Smart Alarm Clock Pro opened")
